...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    "/admin/insights": { ssr: false },
    "/admin/flags": { ssr: false },
    "/admin/impersonation": { ssr: false },
    "/admin/forbidden": { ssr: false },
    ...
    "/en/credit-cards": { ssr: false },
    "/en/credit-cards/**": { ssr: false },
    "/en/insights": { ssr: false },
    "/en/focus": { ssr: false },
    "/en/goals/**": { ssr: false },
    "/en/transactions/**": { ssr: false },
    ...
    "/en/admin/insights": { ssr: false },
    "/en/admin/flags": { ssr: false },
    "/en/admin/impersonation": { ssr: false },
    "/en/admin/forbidden": { ssr: false },
  },
