        ...
        <div class="profile-modal__grid">
          ...
          <UiFormField label="Investimento inicial (R$)" field-id="pm-init-inv" :error="errors.initial_investment">
            <input
              ...
              class="profile-modal__input"
              :class="/* v8 ignore next */ { 'profile-modal__input--error': !!errors.initial_investment }"
              type="number"
              min="0"
              step="0.01"
              placeholder="0,00"
          ...
          <UiFormField label="Aporte mensal (R$)" field-id="pm-monthly-inv" :error="errors.monthly_investment">
            <input
              ...
              class="profile-modal__input"
              :class="/* v8 ignore next */ { 'profile-modal__input--error': !!errors.monthly_investment }"
              type="number"
              min="0"
              step="0.01"
              placeholder="0,00"
          ...
          <UiFormField label="Data meta de investimento" field-id="pm-goal-date" :error="errors.investment_goal_date">
            <input
              ...
              class="profile-modal__input"
              :class="/* v8 ignore next */ { 'profile-modal__input--error': !!errors.investment_goal_date }"
              type="date"
              :disabled="isPending"
