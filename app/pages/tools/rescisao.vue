...
<template>
  ...
  <div v-else class="rescisao-page">
    <header class="rescisao-page__header">
      <div class="rescisao-page__brand">
        <span class="rescisao-page__brand-mark">Auraxis</span>
        <span class="rescisao-page__brand-copy">{{ t('rescisao.header.publicTool') }}</span>
      </div>
      <div class="rescisao-page__header-actions">
        <NButton quaternary @click="router.push('/tools')">{{ t('rescisao.header.otherTools') }}</NButton>
        <NButton type="primary" @click="router.push('/register')">{{ t('rescisao.header.createAccount') }}</NButton>
      </div>
    </header>

    <main class="rescisao-page__content">
      <section class="rescisao-page__hero">
        <div class="rescisao-page__hero-copy">
          <NTag round type="error">{{ t('rescisao.hero.badge') }}</NTag>
          <UiPageHeader
            :title="t('rescisao.hero.title')"
            :subtitle="t('rescisao.hero.subtitle')"
          />
        ...
        <UiGlassPanel glow class="rescisao-page__form-panel">
          <NForm @submit.prevent="handleCalculate">
            <CalculatorFormSection :title="t('rescisao.form.title')">
              <NFormItem :label="t('rescisao.form.grossSalary')">
                <NInputNumber
      ...
      <section v-if="result" class="rescisao-page__results-section">
        <div class="rescisao-page__layout">
          <div class="rescisao-page__results-main">
            <!-- Breakdown card -->
            <UiSurfaceCard>
              <p class="rescisao-page__section-title">{{ t('rescisao.results.title') }}</p>
              <div class="rescisao-page__breakdown">
                <div class="rescisao-page__breakdown-row">
                  <span>{{ t('rescisao.results.saldoSalario') }}</span>
                  <span>{{ formatBrl(result.saldoSalario) }}</span>
          ...
          <div class="rescisao-page__results-aside">
            <UiStickySummaryCard>
              <CalculatorResultSummary
                :label="t('rescisao.results.netTotal')"
                :value="formatBrl(result.netTotal)"
