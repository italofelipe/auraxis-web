...
/**
 * Static admin overview kept behind the `web.admin.dashboard` flag.
 *
 * This is the pre-dashboard content of `/admin`, extracted verbatim so the
 * production surface stays byte-for-byte identical until the metrics
 * dashboard is promoted (`enabled-dev` → `enabled-prod`).
 */
