...
const headers = computed(
  (): readonly string[] => wizard.detectResult.value?.headers ?? [],
);
</script>
  ...
  <div class="spreadsheet-import">
    ...
    <template v-if="wizard.step.value === 'preview' || wizard.step.value === 'review'">
      <NCard :title="t('import.preview.title')">
        <div class="spreadsheet-import__summary">
        ...
        <div class="spreadsheet-import__actions">
