...
const DEV_CSP = [
  ...
  "connect-src 'self' ws: wss: http://localhost:* https://api.auraxis.com.br https://v2.auraxis.com.br https://brapi.dev https://*.sentry.io",
...
const STAGING_CSP = [
  ...
  "connect-src 'self' https://api.auraxis.com.br https://v2.auraxis.com.br https://brapi.dev https://*.sentry.io",
  "frame-ancestors 'none'",
  "base-uri 'self'",
  "object-src 'none'",
  "form-action 'self'",
...
export const PRODUCTION_CSP = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://api.auraxis.com.br https://v2.auraxis.com.br https://brapi.dev https://*.sentry.io https://*.posthog.com",
  "frame-ancestors 'none'",
  "base-uri 'self'",
  "form-action 'self'",
].join("; ");
